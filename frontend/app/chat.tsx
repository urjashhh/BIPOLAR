    ...
    try {
      ...
      if (BACKEND_URL && BACKEND_URL !== "undefined") {
        ...
        const response = await fetch(`${BACKEND_URL}/api/chat`, {
          ...
          body: JSON.stringify({ message: userMessage, user: "default_user" }),
        });
        if (response.ok) {
      ...
      if (!aiResponse) {
        ...
        const responses = [
          ...
          "I appreciate you sharing that with me. Have you been able to track your mood today? Sometimes noticing patterns can help.",
          "You're not alone in this. Many people face similar challenges. What small thing could you do today to take care of yourself?",
        ];
